 ...
 * @Description : 基础 BottomSheetDialogFragment 类，提供视图绑定和 ViewModel 绑定功能
 *
...
abstract class BaseBottomSheetDialogFragment<VB : ViewBinding, VM : BaseViewModel>(
...
) : BottomSheetDialogFragment(), InitListener {
    ...
    /**
     * BottomSheetDialogFragment 的生命周期方法：创建视图
    ...
    /**
     * BottomSheetDialogFragment 的生命周期方法：视图创建完成
    ...
    /**
     * BottomSheetDialogFragment 的生命周期方法：销毁视图
